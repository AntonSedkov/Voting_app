package by.anthony.hateoasexample.controller;
...
import by.anthony.hateoasexample.util.ValidationUtil;
...
public class AccountController implements RepresentationModelProcessor<RepositoryLinksResource> {
    ...
    private static final RepresentationModelAssemblerSupport<User, EntityModel<User>> ASSEMBLER =
            new RepresentationModelAssemblerSupport<>(
    ...
    public ResponseEntity<EntityModel<User>> register(@Valid @RequestBody User user) {
        ...
        URI uriOfNewResource = ServletUriComponentsBuilder.fromCurrentContextPath()     // URL of created entity
                .path("api/account")
                .build().toUri();
        return ResponseEntity.created(uriOfNewResource).body(ASSEMBLER.toModel(user));                     // return URL in the body
    }
    ...
    public PagedModel<EntityModel<User>> showPageUser(Pageable page, PagedResourcesAssembler<User> pagedAssembler) {
